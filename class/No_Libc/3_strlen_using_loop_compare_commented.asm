...
section .text
    ...
    _start:
        ...
        ;write(stdout,usage_str, usage_len)
    ...
    print_number:
        ...
        .divloop:
            ...
            add rdx, 48                 ; convert remainder(each digit) to ASCII digit 
            dec rsp
            mov BYTE [rsp], dl          ; and store it on the stack- find the lower 8 bytes 
            inc rcx
            cmp rax, 0                  ; if quotient is 0: quotient in rax
